...
public class PlantServiceTablePerClass {
    private PlantDaoTablePerClass dao = new PlantDaoTablePerClass();
    ...
    private void addPlant() {
        ...
        System.out.println("press 1: medicinal plant, 2: ornamental plant, any key to create Base plant");
        ...
        switch (medororn){
            ...
            case 2:
                ...
                break;
            default:
                System.out.println("Creating Base plant");
                plantEntity = new PlantEntity(plantName, plantKind);
                break;
        }
